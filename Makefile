...
./demo/Demo2.urp: ./Makefile ./demo/Demo2.ur ./demo/Demo2.urs ./lib.urp .cake3/tmpDemo2.in5
	cat .cake3/tmpDemo2.in5 > ./demo/Demo2.urp
.cake3/tmpDemo2.in5: ./Makefile
	-rm -rf .cake3/tmpDemo2.in5
	echo 'database dbname=Demo2' >> .cake3/tmpDemo2.in5
	echo 'safeGet Demo2/main' >> .cake3/tmpDemo2.in5
	echo 'safeGet Demo2/monitor' >> .cake3/tmpDemo2.in5
	echo 'allow env PING' >> .cake3/tmpDemo2.in5
	echo 'sql .././demo/Demo2.sql' >> .cake3/tmpDemo2.in5
	echo 'library ../.' >> .cake3/tmpDemo2.in5
	echo '' >> .cake3/tmpDemo2.in5
	echo '$$/list' >> .cake3/tmpDemo2.in5
	echo '$$/char' >> .cake3/tmpDemo2.in5
	echo '$$/string' >> .cake3/tmpDemo2.in5
	echo '.././demo/Demo2' >> .cake3/tmpDemo2.in5
...
.PHONY: .cake3/tmpDemo2.in5
.cake3/tmpDemo2.in5: .fix-multy1
